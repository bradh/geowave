 ...
 * Command line options must provided in order:
 * 
 * zookeeper-host:port accumulo-instance-name user password namespace adapterId comma-separated-authorizations
 * 
 */
public class StatsTool
{
	...
	public static void main(
		...
		final String authorizations = args[6];
